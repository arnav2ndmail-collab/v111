-- ============================================================
-- Karle — Complete Database Setup (run this ONCE)
-- Supabase Dashboard → SQL Editor → New Query → Run
-- WARNING: Drops all existing data and recreates fresh
-- ============================================================
...
CREATE POLICY "Users delete own attempts"
  ON test_attempts FOR DELETE USING (auth.uid() = user_id);
...
-- ── 3. site_config (exam countdowns, announcements) ──────────
...
-- ── Done ─────────────────────────────────────────────────────
SELECT 'Karle DB setup complete ✓' AS status;

...
const NAV_LINKS = [
  ...
  { href:'/analytics', label:'My Analytics', svg:<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg> },
    ...
    <>
      ...
      <header className="tz-nav">
        <Link href="/" className="tz-logo">
          <div className="tz-lm">TZ</div>
          <span className="tz-lt">Test<span>Zyro</span></span>
        </Link>
